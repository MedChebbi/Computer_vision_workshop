...
imgRaw[:] = (255,255,255) #replacing the RGB values of the image all white
#draw whatever you want using cv2.line(), cv2.arrowedLine(), cv2.rectangle(), cv2.circle() and cv2.putText() on imgRaw
#code here:
#cv2.putText(imgRaw,"hello",(200,100),cv2.FONT_HERSHEY_SIMPLEX, 1.5, (255,0,255), 2)
#cv2.rectangle(imgRaw,(40,40),(200,400),(255,0,0),2)
cv2.circle(imgRaw,(300,100),100,(0,255,0),cv2.FILLED)
